...
public class CameraIntegrationTest {
    ...
    public void cameraPlaneIntegration(){
        ...
        assertCountIntersections(9,cam, new Plane( new Vector(0, 0, 1),new Point(0, 0, -5)), 3, 3);

        // TC02: Plane with small angle 9 points
        assertCountIntersections(9,cam, new Plane( new Vector(0, 1, 2),new Point(0, 0, -5)), 3, 3);

        // TC03: Plane parallel to lower rays 6 points
        assertCountIntersections(6,cam, new Plane(new Vector(0, 1, 1),new Point(0, 0, -5)), 3, 3);
